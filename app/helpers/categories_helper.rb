module CategoriesHelper
  def show_categories_resume
    @categories.first(2).each do |cat|
      ...
      concat content_tag(:div, content_tag(:div, link_to(cat.name, category_path(cat), class: 'read-more-link text-decoration-none'), class: 'mt-4 h5 text-dark d-inline-block h5-underline font-weight-bold text-decoration-none') +
                             ...
                             content_tag(:div, link_to('Read More', article_path(cat.articles.last), class: 'read-more-link text-decoration-none'), class: 'mt-5'),
